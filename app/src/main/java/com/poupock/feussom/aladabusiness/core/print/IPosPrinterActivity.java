//package com.poupock.feussom.aladabusiness.core.print;
//
...
//
//public class IPosPrinterActivity extends Activity implements OnClickListener {
//
//    private static final String TAG                 = "IPosPrinterActivity";
//    /* Demo 版本号*/
...
//                    break;
//                case MSG_IS_BUSY:
//                    Toast.makeText(IPosPrinterActivity.this, R.string.printer_is_working, Toast.LENGTH_SHORT).show();
//                    break;
//                case MSG_PAPER_LESS:
//                    loopPrintFlag = DEFAULT_LOOP_PRINT;
//                    Toast.makeText(IPosPrinterActivity.this, R.string.out_of_paper, Toast.LENGTH_SHORT).show();
//                    break;
//                case MSG_PAPER_EXISTS:
//                    Toast.makeText(IPosPrinterActivity.this, R.string.exists_paper, Toast.LENGTH_SHORT).show();
//                    break;
//                case MSG_THP_HIGH_TEMP:
//                    Toast.makeText(IPosPrinterActivity.this, R.string.printer_high_temp_alarm, Toast.LENGTH_SHORT).show();
//                    break;
//                case MSG_MOTOR_HIGH_TEMP:
//                    loopPrintFlag = DEFAULT_LOOP_PRINT;
//                    Toast.makeText(IPosPrinterActivity.this, R.string.motor_high_temp_alarm, Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(IPosPrinterActivity.this, R.string.printer_current_task_print_complete, Toast.LENGTH_SHORT).show();
//                    break;
//                default:
//                    break;
//            }
...
//        b_pic =  findViewById(R.id.b_pic);
//        b_qcode =  findViewById(R.id.b_qcode);
//        b_self =  findViewById(R.id.b_self);
//        b_text =  findViewById(R.id.b_text);
//        b_table =  findViewById(R.id.b_table);
//        b_init =  findViewById(R.id.b_init);
//        b_lines =  findViewById(R.id.b_lines);
//        b_test =  findViewById(R.id.b_test);
//        b_runpaper =  findViewById(R.id.b_runpaper);
//        b_length =  findViewById(R.id.b_length);
//        b_continu =  findViewById(R.id.b_continu);
//        b_motor =  findViewById(R.id.b_motor);
//        b_wave =  findViewById(R.id.b_wave);
//        b_koubei =  findViewById(R.id.b_koubei);
//        b_error =  findViewById(R.id.b_error);
//        b_loop =  findViewById(R.id.b_loop);
//        b_demo =  findViewById(R.id.b_demo);
//
...
//
//        b_bytes =  findViewById(R.id.b_bytes);
//        b_query =  findViewById(R.id.b_query);
//        b_baidu =  findViewById(R.id.b_baidu);
//        b_meituan =  findViewById(R.id.b_meituan);
//        b_erlmo =  findViewById(R.id.b_erlmo);
//        b_testall =  findViewById(R.id.b_testall);
//
//

...
public class PutTask extends AsyncTask<Void, Void, Void> {
    ...
    public PutTask(Context context, String url, JSONObject params, VolleyRequestCallback callback){
        this.context = context;
        this.url = url;
        this.paramJsonObject = params;
        this.callback = callback;
    }
    ...
    protected Void doInBackground(Void... voids) {
        ...
        JsonObjectRequest connectObjectRequest = new JsonObjectRequest(Request.Method.PUT, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                try {
                    ...
                    Log.e(tag,"The Null error "+exception) ;
